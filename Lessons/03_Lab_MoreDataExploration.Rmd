...
highs.f = c(49,42,43,40,26,46)
lows.f = c(30,24,30,15,17,25)
...
c.to.f <- function(temps){round((temps-32) * 5/9, 2)}

highs.c = c.to.f(highs.f)
lows.c = c.to.f(lows.f)
...
temps.df <- data.frame("Highs F" = highs.f,"Lows F" = lows.f,"Highs C" = highs.c, "Lows C" = lows.c)
temps.df
